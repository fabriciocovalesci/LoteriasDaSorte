...
const dataYear = Array.from({ length: 29 }, (v, k) => k + 1994).reverse()
            ...
            <ScrollView>
                 {selectedLanguage === 'ocorrencias' ?
                    <>
                    {
                        ...
                        <>
                        <View>
                            <MyBarChart color="#058ce1" dezenas={megaChart} tituloBar="Maior Ocorrências" subtituloBar="10 dezenas Mais sorteadas" />
                        </View>
                        <DataTable>
                    ...
                    <>
                        <View>
                            <MyBarChartAtraso color="#058ce1" dezenas={megaChartAtraso} tituloBar="Maiores Atrasos" subtituloBar="10 dezenas Mais atrasadas" />
                        </View>
                        <DataTable>
                            <DataTable.Header style={{}}>
                                <DataTable.Title >Dezena</DataTable.Title>
                    ...
                    <>
                        <View>
                        <MyBarChartSequencia color="#058ce1" dezenas={megaChartAtraso} tituloBar="Maiores Sequências" subtituloBar="Máximo de sequências da Mega Sena" />
                        </View>
                        <DataTable>
                            <DataTable.Header style={{}}>
                                <DataTable.Title >Dezena</DataTable.Title>
                    ...
                    <View style={{  }}>
                        ...
                        <View style={{ alignSelf: "center", marginTop: 0 }}>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>3 Pares e 2 Ímpares: {megaSomaPercent.equal.jogos} jogos</Text>
                                <Text>{megaSomaPercent.equal.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.equal.porcentagem / 100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>2 Pares e 3 Ímpares: {megaSomaPercent.Combinada_1.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_1.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_1.porcentagem / 100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>4 Pares e 1 Ímpares: {megaSomaPercent.Combinada_2.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_2.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_2.porcentagem/100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>1 Pares e 4 Ímpares: {megaSomaPercent.Combinada_3.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_3.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_3.porcentagem/100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>0 Pares e 5 Ímpares: {megaSomaPercent.Combinada_4.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_4.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_4.porcentagem/100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>5 Pares e 0 Ímpares: {megaSomaPercent.Combinada_5.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_5.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_5.porcentagem/100} color='#058ce1' height={10} width={Dimensions.get('screen').width - 40} />
                        </View>
                    ...
                    <MenuAgrupamentos />
                    {
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-around", alignContent: "center" }}>
                        {
                            checked ?
                                ...
                                : checkedDetail ?
                                    ...
                                    : CheckedFreqMA ?
                                    <View>
                                        <GraficoBarMesAno color="#058ce1" dezenas={countDezByMesAno.slice(0,10)} data={mesAno} />
                                        <DataTable>
                                    <Text style={{ fontWeight: "bold", marginLeft: 15 }}>Mês - Ano: {moment.months(mesAno.substr(5, 7) - 1)} de {mesAno.substr(0, 4)}</Text>
                                    <DataTable.Header style={{}}>
                                        <DataTable.Title >Concurso</DataTable.Title>
                        ...
                        </View>
                        {
                            ...
                            : CheckedFreqA ?
                            <View>
                                <GraficoBarYear color="#058ce1" dezenas={countDezByAno.slice(0,10)} ano={selectedYear}/>
                                <DataTable>
                        ...
                        <ScrollView>
                            <GraficoGroup color="#058ce1" ano={selectedAnoCompare} dezenas={compareArray}/>
                        <DataTable>
