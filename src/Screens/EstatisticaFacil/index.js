                 ...
                 {selectedLanguage === 'ocorrencias' ?
                    ...
                    <View style={{  }}>
                        ...
                        <View style={{ alignSelf: "center", marginTop: 0 }}>
                            ...
                            <Progress.Bar progress={megaSomaPercent.Combinada_1.porcentagem / 100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>6 pares e 9 ímpares: {megaSomaPercent.Combinada_2.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_2.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_2.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>9 pares e 6 ímpares: {megaSomaPercent.Combinada_3.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_3.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_3.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>5 pares e 10 ímpares: {megaSomaPercent.Combinada_4.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_4.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_4.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>10 pares e 5 ímpares: {megaSomaPercent.Combinada_5.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_5.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_5.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>4 pares e 11 ímpares: {megaSomaPercent.Combinada_6.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_6.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_6.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                            <Divider style={{marginBottom: 10}}/>
                            <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
                                <Text>11 pares e 4 ímpares: {megaSomaPercent.Combinada_7.jogos} jogos</Text>
                                <Text>{megaSomaPercent.Combinada_7.porcentagem} %</Text>
                            </View>
                            <Progress.Bar progress={megaSomaPercent.Combinada_7.porcentagem/100} color='red' height={10} width={Dimensions.get('screen').width - 40} />
                        </View>
                        <View style={{marginTop: 15, marginBottom: 5}}>
                        <Text style={{ textAlign: "center", marginBottom: 10, fontWeight: "bold" }}>Tabela dos Números Pares e Ímpares</Text>
                        </View>
